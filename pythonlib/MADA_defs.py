...
CPP_MACARON_SCALER    = "MACARON_runScaler"
...
CTRL_CMD_SCALER_START = 0b00001110.to_bytes( 1, "little" )
CTRL_CMD_SCALER_STOP  = 0b00001111.to_bytes( 1, "little" )

CTRL_CMD_LVCHECK    = 0b00100000.to_bytes( 1, "little" )
CTRL_CMD_LVSTATUS   = 0b00100001.to_bytes( 1, "little" )
CTRL_CMD_LVRESET    = 0b00100010.to_bytes( 1, "little" )
...
PACKET_SCALER_START = CTRL_SYS_MIRACLUE + CTRL_ROLE_MASTER + CTRL_CMD_SCALER_START + CTRL_VAL_TRUE
PACKET_SCALER_STOP  = CTRL_SYS_MIRACLUE + CTRL_ROLE_MASTER + CTRL_CMD_SCALER_STOP  + CTRL_VAL_TRUE
