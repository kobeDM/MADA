...
int main( int argc, char *argv[] )
{
    ...
    while ( iwaki.isAlive( ) && !end_flag ) {
        ...
        if ( num > 0 && num < 28679 ) {
            for ( int i = 0; i < num; i++ ) {
                //	if(i>28679)break;
                if ( ( event_data == 0 && ( msg[i] & 0xff ) == 0xeb ) || ( event_data == 1 && ( msg[i] & 0xff ) == 0x90 ) || ( event_data == 2 && ( msg[i] & 0xff ) == 0x19 ) || ( event_data == 3 && ( msg[i] & 0xff ) == 0x64 ) ) {
                    event_data++;
                    evt_data.push_back( msg[i] );
                    image->Reset( );
                } else if ( event_data == 4 || event_data == 5 || event_data == 6 || event_data == 7 || event_data == 8 || event_data == 9 || event_data == 10 || event_data == 11 || event_data == 12 || event_data == 13 || event_data == 14 || event_data == 15 ) {
                    event_data++;
                    evt_data.push_back( msg[i] );
                ...
                if ( event_data > 16 ) {
                    ...
                    cout << dec;
                    cout << endl << "trig counter" << setw( 8 ) << setfill( '0' ) << evt_cnt << " " << endl << "clock counter" << setw( 8 ) << setfill( '0' ) << clk_cnt << " " << endl << "signal counter" << setw( 8 ) << setfill( '0' ) << trg_cnt << endl;
                    ...
                    if ( evt_data.size( ) > 20 ) {
                        ...
                        cout << setw( 2 ) << setfill( '0' ) << ( evt_data.at( 8208 ) & 0xff ) << setw( 2 ) << setfill( '0' ) << ( evt_data.at( 8209 ) & 0xff ) << setw( 2 ) << setfill( '0' ) << ( evt_data.at( 8210 ) & 0xff ) << setw( 2 ) << setfill( '0' ) << ( evt_data.at( 8211 ) & 0xff ) << endl;
