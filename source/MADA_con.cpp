...
int main(int argc, char *argv[])
{
  ...
  **/
  ...
  for(int gigaIwakiid=0; gigaIwakiid<    numgigaIwaki; gigaIwakiid++){
    //  thread th1(iwaki_read,gigaIwaki_IP[0]);
    //th1.join();
    ths[gigaIwakiid]=thread(iwaki_read,gigaIwaki_IP[gigaIwakiid],numperfile,f_index);
    cout <<"board "<<gigaIwakiid<<" thread ID for GBKB with IP "<<gigaIwaki_IP[gigaIwakiid]<<" is "<< ths[gigaIwakiid].get_id()<<endl;
    //ths[gigaIwakiid].isBackground(true);
    //    ths[gigaIwakiid].join();
    //    ths[gigaIwakiid].detach();
  }
for(int gigaIwakiid=0; gigaIwakiid<    numgigaIwaki; gigaIwakiid++){
      ths[gigaIwakiid].join();
 }
