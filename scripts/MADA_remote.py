...
def run_daq(config_path, period_id, file_num, event_num):
    ...
    for file_id in range(file_num):
        try:
            ...
            run_adalm_control(adalm_serial_daq_enable, latch=1, bg=True)
...
def main():
    ...
    while True:
        ...
        run_daq(config_path, period, file_num, event_num)
        exit()
