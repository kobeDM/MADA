...
f.write(t+"\t"+str(int(starttime))+"\t"+str(int(endtime))+"\t"+str(int(size[0]))+"\t"+str(int(size[1]))+"\t"+str(int(size[2]))+"\t"+str(int(size[3]))+"\t"+str(int(size[4]))+"\t"+str(int(size[5]))+"\t"+str(
    int(size[0])/realtime)+"\t"+str(int(size[1])/realtime)+"\t"+str(int(size[2])/realtime)+"\t"+str(int(size[3])/realtime)+"\t"+str(int(size[4])/realtime)+"\t"+str(int(size[5])/realtime)+"\n")
f.close()
